                    ...
                    public void run() {
                        try {
                            ...
                            Request request = new Request.Builder()
                                    .url("http://192.168.18.101:5000/start_auto_trade")
                    ...
                    public void onClick(View v) {
                        ...
                        if (!quantity.isEmpty() && !symbol.isEmpty()) {
                            ...
                            try {
                                ...
                                // Tạo request POST
                                Request request = new Request.Builder()
                                        .url("http://192.168.18.101:5000/place_order")
                                        .post(formBody)
                                        .build();
                                okHttpClient.newCall(request).enqueue(new Callback() {
                                    @Override
                    ...
                    public void onClick(View v) {
                        ...
                        if (!quantity.isEmpty() && !symbol.isEmpty()) {
                            ...
                            try {
                                ...
                                // Tạo request POST
                                Request request = new Request.Builder()
                                        .url("http://192.168.18.101:5000/send_limit")
                                        .post(formBody)
                                        .build();
                                okHttpClient.newCall(request).enqueue(new Callback() {
                                    @Override
                    ...
                    public void onClick(View v) {
                        ...
                        if (!quantity.isEmpty() && !symbol.isEmpty()) {
                            ...
                            try {
                                ...
                                // Tạo request POST
                                Request request = new Request.Builder()
                                        .url("http://192.168.18.101:5000/buy_market")
                                        .post(formBody)
                                        .build();
                                okHttpClient.newCall(request).enqueue(new Callback() {
                                    @Override
                    ...
                    public void onClick(View v) {
                        ...
                        if (!quantity.isEmpty() && !symbol.isEmpty()) {
                            ...
                            try {
                                ...
                                // Tạo request POST
                                Request request = new Request.Builder()
                                        .url("http://192.168.18.101:5000/send_market")
                                        .post(formBody)
                                        .build();
                                okHttpClient.newCall(request).enqueue(new Callback() {
                                    @Override
        ...
        btnQueue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    // Tạo request POST
                    Request request = new Request.Builder()
                            .url("http://192.168.18.101:5000/open_orders_json")
                            .post(formBody)
                            .build();
                    okHttpClient.newCall(request).enqueue(new Callback() {
                        @Override
                                ...
                                try {
                                    ...
                                    for (int i = 0; i < btcusdtArray.length(); i++) {
                                        ...
                                        MainActivity3.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(MainActivity3.this, "hello "+ queueList.get(0).getSymbol(), Toast.LENGTH_LONG).show();
                                            }
                                        });
                                    }
                                    if(queueList.size() > 0) {
